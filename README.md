...
```sh
pip install git+https://github.com/joeynebula/ynab_pie.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/joeynebula/ynab_pie.git`)
