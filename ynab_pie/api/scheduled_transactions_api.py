...
class ScheduledTransactionsApi(object):
    ...
    def get_scheduled_transaction_by_id(self, budget_id, scheduled_transaction_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_scheduled_transaction_by_id(budget_id, scheduled_transaction_id, async_=True)
        >>> result = thread.get()
    ...
    def get_scheduled_transaction_by_id_with_http_info(self, budget_id, scheduled_transaction_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_=True
        >>> thread = api.get_scheduled_transaction_by_id_with_http_info(budget_id, scheduled_transaction_id, async_=True)
        >>> result = thread.get()
    ...
    def get_scheduled_transactions(self, budget_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_=True
        >>> thread = api.get_scheduled_transactions(budget_id, async_=True)
        >>> result = thread.get()
    ...
    def get_scheduled_transactions_with_http_info(self, budget_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_=True
        >>> thread = api.get_scheduled_transactions_with_http_info(budget_id, async_=True)
        >>> result = thread.get()
